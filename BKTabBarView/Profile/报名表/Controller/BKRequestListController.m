...
@interface BKRequestListController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation BKRequestListController
...
//    intoMyChoiceBtn.backgroundColor = BKColorBlue;
    ...
    [intoMyChoiceBtn setTitle:@"进入我的心愿单" forState:UIControlStateNormal];
    [intoMyChoiceBtn addTarget:self action:@selector(intoMyFinalList) forControlEvents:UIControlEventTouchUpInside];
