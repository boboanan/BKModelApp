...
@interface BKMyAnounceController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation BKMyAnounceController
...
{
    BKMyAnounceCell *cell = [BKMyAnounceCell cellWithTableView:tableView];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BKAnounceDetailController *anounceDetailController = [[BKAnounceDetailController alloc] init];
    [self.navigationController pushViewController:anounceDetailController animated:YES];
}
